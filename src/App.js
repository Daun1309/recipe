    ...
    <div className='cheflee'>
      ...
      <div className="chef-app">
        <BrowserRouter>
          ...
          <main>
          <Myrecipe.Provider value={{data:data, setData:setData,serchTxt:serchTxt, num:num, serch:serch, elInput:elInput, remScroll:remScroll, setScroll:setScroll, hates:hates, hate:hate, ulBox:ulBox}}>
            <Routes>
